...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Sun Jul 25 16:35:50 2010
# Project:  GTestRunner.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.6.2/bin/qmake -unix CONFIG+=debug_and_release -o Makefile GTestRunner.pro
#############################################################################
...
Makefile: GTestRunner.pro  /usr/local/Trolltech/Qt-4.6.2/mkspecs/linux-g++-64/qmake.conf /usr/local/Trolltech/Qt-4.6.2/mkspecs/common/g++.conf \
